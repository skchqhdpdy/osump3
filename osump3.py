                ...
                if q:
                    ...
                    if sn:
                        try:
                            ...
                            AudioFilename_search, PreviewTime_search, BeatmapID_search, BeatmapBG_search, BeatmapVideo_search = osu_file_read(sn) if option != 1 and option != 2 and option != 4 else (None, None, None, None, None)
